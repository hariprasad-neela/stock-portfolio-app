...
export const getHistoricalData = async (req, res) => {
    try {
        ...
        // Note: This requires the 'orders' permission in your Kite Connect App
        const response = await fetch('https://api.kite.trade/instruments/historical/' + silverbees_instrument_token + '/15minute?from=' + from_date + '+09:15:00&to=' + to_date + '+15:30:00', {
            headers: {
                'Authorization': `token ${process.env.ZERODHA_API_KEY}:${kite.access_token}`,
                'X-Kite-Version': '3'
            }
