...
| `/api/stocks` | GET | `[{stock_id, ticker, display}, ... }]` | Master stock list for Redux initialization. |
| `/api/transactions/open` | GET | `[{transaction_id, ticker, quantity, price, ...}]` | Current open inventory for decision support. |
